...
<div ref={divRef} className="max-w-sm border rounded-lg bg-white dark:bg-[#141414] border-gray-200 dark:border-[#141414]">
      ...
      <div className={`${imageLoaded?"hidden":"block"} rounded-t-xl`}>
        ...
        <img className={`${!imageLoaded?"hidden":"block"} rounded-t-lg`} src={ImageUrl} alt="Img" />
...
<span className='mx-1 text-gray-700 dark:text-white'>{Likes}</span>
